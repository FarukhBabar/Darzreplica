...
const Decosingle = () => {
    ...
    let fdata = Decro.find(x => x.id == params.id)
    const incQty=()=>{
        setqty(qty+1)
    }
    const decQty=()=>{
            ...
            <div className="card-body">
                ...
                <div className="row">
                    <div className="col-lg-5 col-md-5 col-sm-6">
                        <div className="white-box text-center mt-3"><img src={fdata.image} height={400} width={400} className="img-responsive asdf rounded" /></div>
                    </div>
                    <div className="col-lg-7 col-md-7 col-sm-6">
                        ...
                        <br/><br/>
                            ...
                            <button className="btn btn1 btn-rounded mr-1 buy" data-toggle="tooltip" onClick={handleAddToCart} title data-original-title="Add to cart">Add To Cart
                        </button>
