...
//     let fdata = Food.find(x => x.id == params.id)
//     const incQty=()=>{
//         setqty(qty+1)
//     }
//     const decQty=()=>{
...
//             <div className="card mainn d-flex ">
...
//                             <div className="white-box text-center col-sm-6 mt-3"><img src={fdata.image} height={400} width={400} className="img-responsive rounded" /></div>
//                         </div>
//                         <div className="col-lg-7 col-md-7 col-sm-6">
...
//                                     <button onClick={decQty} className='btn btn-dark btn-md ms-2 h-25'>-</button>
//                                        <h4 className='ms-2'>{qty}</h4> 
//                                     <button onClick={incQty} className='btn btn-dark btn-md ms-2 h-25'>+</button>
//                                     <br/><br/>
//                                 </div>
//                                     <h3 className='text-danger'>Total Ammount:${fdata.price*qty}</h3>
//                                     <div className='d-flex'>
//                                 <button className="btn btn1 btn-rounded ms-3 mr-1 buy"  onClick={handleAddToCart} data-toggle="tooltip" title data-original-title="Add to cart">Add To Cart</button>
//                             <button className="btn bt2 btn-rounded ms-3 mt-2 buy" onClick={buynow}>Buy Now</button>
//                             </div>
