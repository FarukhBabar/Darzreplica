...
const Fashionsingle = () => {
    ...
    let fdata = Fashion.find(x => x.id == params.id)
    const incQty=()=>{
        setqty(qty+1)
    }
    const decQty=()=>{
                ...
                <div className="row">
                    ...
                    <div className="col-lg-7 col-md-7 col-sm-6">
                        ...
                        <br/><br/>
                            ...
                            <button className="btn btn1 btn-rounded mr-1 buy" onClick={handleAddToCart} data-toggle="tooltip" title data-original-title="Add to cart">Add To Cart
                        </button>
